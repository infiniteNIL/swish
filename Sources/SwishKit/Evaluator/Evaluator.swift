...
public class Evaluator {
    ...
    private func evalThrow(_ elements: [Expr], in env: Environment) throws -> Expr {
        guard elements.count == 2
        else {
    ...
    private func evalTry(_ elements: [Expr], in env: Environment) throws -> Expr {
    ...
    private func exprForError(_ error: Error) -> Expr {
