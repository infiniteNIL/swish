...
- [x] Clojure-faithful auto-refer (in-ns/create-ns are bare, the ns form refers clojure.core with :refer-clojure support, removed resolveVar's
      core fallback)
- [x] implemented ns-unmap, remove-ns, refer-clojure. (Deferred: import — no host classes.)
